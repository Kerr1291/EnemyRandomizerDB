...
namespace EnemyRandomizerMod.Futils.Serialiser{
    internal static class ActionReader
    { 
        public static object GetFsmObject(this ActionData actionData, int index, int dataVersion)
        {
            var byteData = ReflectionHelpers.GetField<HutongGames.PlayMaker.ActionData, List<byte>>(actionData, "byteData");

            BinaryReader r = new BinaryReader(new MemoryStream(byteData.ToArray()));
            //string actionName = actionData.actionNames[index];
            var fsmEnumParams = ReflectionHelpers.GetField<HutongGames.PlayMaker.ActionData, List<FsmEnum>>(actionData, "fsmEnumParams");
            var fsmBoolParams = ReflectionHelpers.GetField<HutongGames.PlayMaker.ActionData, List<FsmBool>>(actionData, "fsmBoolParams");
            var fsmIntParams = ReflectionHelpers.GetField<HutongGames.PlayMaker.ActionData, List<FsmInt>>(actionData, "fsmIntParams");
            var fsmFloatParams= ReflectionHelpers.GetField<HutongGames.PlayMaker.ActionData, List<FsmFloat>>(actionData, "fsmFloatParams");
            var fsmVector2Params= ReflectionHelpers.GetField<HutongGames.PlayMaker.ActionData, List<FsmVector2>>(actionData, "fsmVector2Params");
            var fsmVector3Params= ReflectionHelpers.GetField<HutongGames.PlayMaker.ActionData, List<FsmVector3>>(actionData, "fsmVector3Params");
            var fsmQuaternionParams= ReflectionHelpers.GetField<HutongGames.PlayMaker.ActionData, List<FsmQuaternion>>(actionData, "fsmQuaternionParams");
            var fsmColorParams= ReflectionHelpers.GetField<HutongGames.PlayMaker.ActionData, List<FsmColor>>(actionData, "fsmColorParams");
            var fsmRectParams = ReflectionHelpers.GetField<HutongGames.PlayMaker.ActionData, List<FsmRect>>(actionData, "fsmRectParams");
            
            var fsmGameObjectParams = ReflectionHelpers.GetField<HutongGames.PlayMaker.ActionData, List<FsmGameObject>>(actionData, "fsmGameObjectParams");
            var fsmOwnerDefaultParams = ReflectionHelpers.GetField<HutongGames.PlayMaker.ActionData, List<FsmOwnerDefault>>(actionData, "fsmOwnerDefaultParams");
            var fsmObjectParams = ReflectionHelpers.GetField<HutongGames.PlayMaker.ActionData, List<FsmObject>>(actionData, "fsmObjectParams");
            var fsmVarParams = ReflectionHelpers.GetField<HutongGames.PlayMaker.ActionData, List<FsmVar>>(actionData, "fsmVarParams");
            var fsmStringParams = ReflectionHelpers.GetField<HutongGames.PlayMaker.ActionData, List<FsmString>>(actionData, "fsmStringParams");
            var stringParams = ReflectionHelpers.GetField<HutongGames.PlayMaker.ActionData, List<string>>(actionData, "stringParams");
            var fsmEventTargetParams = ReflectionHelpers.GetField<HutongGames.PlayMaker.ActionData, List<FsmEventTarget>>(actionData, "fsmEventTargetParams");
            var fsmArrayParams = ReflectionHelpers.GetField<HutongGames.PlayMaker.ActionData, List<FsmArray>>(actionData, "fsmArrayParams");
            var unityObjectParams = ReflectionHelpers.GetField<HutongGames.PlayMaker.ActionData, List<UnityEngine.Object>>(actionData, "unityObjectParams");
            var functionCallParams = ReflectionHelpers.GetField<HutongGames.PlayMaker.ActionData, List<FunctionCall>>(actionData, "functionCallParams");

            ParamDataType paramDataType = ReflectionHelpers.GetField<HutongGames.PlayMaker.ActionData, List<ParamDataType>>(actionData, "paramDataType")[index];
            int paramDataPos = ReflectionHelpers.GetField<HutongGames.PlayMaker.ActionData, List<int>>(actionData, "paramDataPos")[index];
            int paramByteDataSize = ReflectionHelpers.GetField<HutongGames.PlayMaker.ActionData, List<int>>(actionData, "paramByteDataSize")[index];
